...
# --- Se crea el selectbox para el ejecutor una sola vez ---
ejecutor = st.selectbox("Ejecutor:", opciones, key="ejecutor_selectbox")
...
if formato_seleccionado == "Cartera":
    if 'num_postes' not in st.session_state:
        st.session_state['num_postes'] = 0
    
    if st.session_state['num_postes'] > 0:
